...
def track_set_error(ground_truth, estimated_tracks, max_dist):
    ...
    print('TIme to run opt assignment: ', end - start)
    ...
    print('TIme to run max_distancest: ', end - start)
    ...
    print('TIme to run wrong_max_distances assignment: ', end - start)
    ...
    print('TIme to run right_distances assignment: ', end - start)
