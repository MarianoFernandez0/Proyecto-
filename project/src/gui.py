...
def display_input_gui():
    ...
    advanced_section_esp = [[sg.Text('Parámetros')],
                        [sg.Text(' detección:          '), sg.InputText('1', key='detection_algorithm', size=(7, 1))],
    ...
    advanced_section_en = [[sg.Text('Algorithm params')],
                        [sg.Text(' detection algorithm: '), sg.InputText('1', key='detection_algorithm', size=(7, 1))],
    ...
    esp_section = [
        ...
        [sg.Text('  ROIx:                '), sg.InputText('512', key='ROIx', size=(7, 1))],
        [sg.Text('  ROIy:                '), sg.InputText('512', key='ROIy', size=(7, 1))],
        [sg.Text('')],
